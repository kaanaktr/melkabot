...
.setColor('RED')
.setDescription(`:x: **Eksik Kullanım : ${prefix}hata-bildir <bulduğunuz hata>**`)
...
.setColor('GREEN')
.setDescription(':white_check_mark: **Botta Bulduğunuz Hata Başarıyla Bildirildi.**\n:white_check_mark: **En Yakın Zamanda <#794553571559342121> Kanalından Cevap Vereceğiz!**')

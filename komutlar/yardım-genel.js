...
exports.run = async (client, message, params, args) => {
  ...
  .setColor("GOLD")
      .setAuthor(`Melka BOT Genel Menüsü`)
      .setThumbnail(message.author.displayAvatarURL({dynamic: true}))
.addField("+istatistik","İstatistiklere bakarsınız.", true)
.addField("+avatar", "Avatarınıza bakarsınız.", true)
  .addField("+davet", "Davet Linkine bakarsınız.", true)
  .addField("+afk", "Afk moduna geçersiniz.", true)
  .addField("+kullanıcı-bilgi", "Başkasının veya kendinizin bilgilerinize bakarsınız.", true)
  .addField("+hata", "Hata bildirirsiniz.", true)
